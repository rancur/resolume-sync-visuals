...
class TestModelConfig:
    ...
    def test_get_model_config_short_name(self):
        ...
        assert cfg["id"] == "wan-ai/wan2.1-t2v-480p"

    def test_get_model_config_full_id(self):
        """Look up model by full Replicate ID."""
        cfg = _get_model_config("wan-ai/wan2.1-t2v-720p")
        assert cfg["id"] == "wan-ai/wan2.1-t2v-720p"
